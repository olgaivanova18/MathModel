...
В начальный момент времени страна $X$ имеет армию численностью 38000 человек, а в распоряжении страны $Y$ армия численностью в 29000 человек.
...
$$
 \begin{cases}
	...
	\\   
	\frac{dy}{dt}= -0.31x(t)y(t) - 0.61y(t) + |cos(7t)|
 \end{cases}
$$
