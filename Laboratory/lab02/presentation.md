...
date: МатМод--2021, 20 февраля, 2021, Москва, Россия
...
![траектории для случая 1](image/screen01.png){ #fig:001 width=50% height=50% }
...
![траектории для случая 2](image/screen02.png){ #fig:002 width=50% height=50% }
...
Увидели, что при погоне «по часовой стрелке» для достижения цели потребуется пройти значительно меньшее расстояние.
